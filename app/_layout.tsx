...
function RootLayoutNav() {
  ...
  React.useEffect(() => {
    ...
    const inAuthGroup = segments[0] === "auth" || segments[0] === "email-signup" || segments[0] === "email-signin" || segments[0] === "forgot-password" || segments[0] === "auth-popup" || segments[0] === "auth-callback";
    ...
    // If user is not in onboarding and checks weren't done, do them
